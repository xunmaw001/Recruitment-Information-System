		...
		<div id="contentText">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">编辑应聘信息</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>编辑应聘信息</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">应聘信息信息</h3>
							<form id="addOrUpdateForm">
								<div class="form-row">
									...
									<div class="form-group col-md-6">
										<label>岗位职责</label>
										<input id="gangweizhize" name="gangweizhize" class="form-control" placeholder="岗位职责">
									</div>
									<div class="form-group col-md-6">
										<label>上班地点</label>
	...
	<script>
		  ...
		  beforeCreate: function(){
			  var id = window.sessionStorage.getItem("id");
				if(id != null && id != "" && id != "null"){
					$.ajax({ 
		                type: "GET",
		                url: baseUrl + "yingpinxinxi/info/" + id,
		...
		function upload(){
			$('#gerenjianliupload').fileupload({
				...
				dataType: 'json',
					...
					document.getElementById('gerenjianli-input').setAttribute('value',baseUrl+'file/download?fileName='+data.result.file);
		...
		function submit() {
			if(validform() ==true && compare() == true){
				...
				httpJson("yingpinxinxi/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
