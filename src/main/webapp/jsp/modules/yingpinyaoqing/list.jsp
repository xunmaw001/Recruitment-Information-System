...
<body>
		...
		<div id="content">
				...
				<div class="container mt-0">
					<div class="row breadcrumb-bar">
						<div class="col-md-6">
							<h3 class="block-title">应聘邀请管理</h3>
						</div>
						<div class="col-md-6">
							<ol class="breadcrumb">
								...
								<li class="breadcrumb-item active"><span>应聘邀请列表</span></li>
							</ol>
						</div>
					</div>
				</div>
				...
				<div class="row">
					...
					<div class="col-md-12">
						<div class="widget-area-2 lochana-box-shadow">
							<h3 class="widget-title">应聘邀请列表</h3>							
							<div class="table-responsive mb-3" id="tableDiv">
								<div class="col-sm-12">
									...
									<input type="text" id="shoujiSearch" class="form-control form-control-sm" placeholder="" aria-controls="tableId">
									<label>
										岗位名称
									</label>
								...
								<table id="tableId" class="table table-bordered table-striped">
									<thead>
										<tr>
											...
											<th onclick="sort('gangweizhize')">岗位职责<i id="gangweizhizeIcon" class="fa fa-sort"></i></th>
											...
											<th onclick="sort('yaoqingshijian')">邀请时间<i id="yaoqingshijianIcon" class="fa fa-sort"></i></th>
	...
	<script>
		...
		function setDataRow(item,number){
			...
			var yaoqingshijianCell  = document.createElement('td');

						  yaoqingshijianCell.innerHTML = item.yaoqingshijian;


			row.appendChild(yaoqingshijianCell);
			var yaoqingneirongCell  = document.createElement('td');

						  if(item.yaoqingneirong != null && item.yaoqingneirong != "" && item.yaoqingneirong.length >= 11){
			  	yaoqingneirongCell.innerHTML = item.yaoqingneirong.substring(0, 10) + "..."; 
			  }else{
			  	yaoqingneirongCell.innerHTML = item.yaoqingneirong;
			  }


			row.appendChild(yaoqingneirongCell);
		...
		function sh(){
			...
			httpJson("yingpinyaoqing/update","POST",data,(res)=>{
				if(res.code == 0){
					$('#addRowModal').hide();
					alert("提交成功");
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("yingpinyaoqing/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
		...
		function crossTable(id,crossTableName){
			...
			window.sessionStorage.setItem('crossTableName',"yingpinyaoqing");
