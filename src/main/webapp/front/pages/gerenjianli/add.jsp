		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
						...
						<div class="layui-input-block">
							<input v-model="detail.jiaoyujingli" type="text" name="jiaoyujingli" id="jiaoyujingli" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                                                                                                                                        <div class="layui-form-item" pane>
						<label class="layui-form-label">技能：</label>
						<div class="layui-input-block">
							<input v-model="detail.jineng" type="text" name="jineng" id="jineng" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                                                <div class="layui-form-item" pane>
						<label class="layui-form-label">自我评价：</label>
						<div class="layui-input-block">
							<input v-model="detail.ziwopingjia" type="text" name="ziwopingjia" id="ziwopingjia" autocomplete="off" class="layui-input">
						</div>
					</div>
                                                            
                                                                                                                                                                                                                                                                                                                                                    <div class="layui-form-item" pane>
						<label class="layui-form-label">工作业绩：</label>
						<div class="layui-input-block">
							<textarea name="gongzuoyeji" id="gongzuoyeji">请输入工作业绩</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var gongzuoyeji = tinymce.get('#gongzuoyeji').getContent()
					data.gongzuoyeji = gongzuoyeji;
					...
					// 提交数据
					http.requestJson('gerenjianli' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
