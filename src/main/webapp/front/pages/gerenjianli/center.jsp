				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="jiaoyujingli" id="jiaoyujingli" placeholder="教育经历" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">工作经历</label>
							<div class="layui-input-block">
								<input type="text" name="gongzuojingli" id="gongzuojingli" placeholder="工作经历" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
							<label class="layui-form-label">技能</label>
							<div class="layui-input-block">
								<input type="text" name="jineng" id="jineng" placeholder="技能" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">自我评价</label>
							<div class="layui-input-block">
								<input type="text" name="ziwopingjia" id="ziwopingjia" placeholder="自我评价" autocomplete="off" class="layui-input">
							</div>
						</div>
