      ...
      <div class="form-inner">
        ...
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="jiaoyujingli" name="jiaoyujingli" placeholder="请输入教育经历" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="jineng" name="jineng" placeholder="请输入技能" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
        <div class="input-wrapper">
          <div class="input-group">
            ...
            <div class="layui-form-item">
              <div class="layui-input-block" style="margin-left: 57px;">
                <input type="text" id="ziwopingjia" name="ziwopingjia" placeholder="请输入自我评价" autocomplete="off" class="layui-input" lay-ignore>
              </div>
            </div>
          </div>
        </div>
