		...
		<div id="app">
			...
			<div class="data-add-container">
				...
				<form class="layui-form layui-form-pane" lay-filter="myForm">
                        ...
                        <div class="layui-input-block">
                            <select name="qiyeleixing" id="qiyeleixing" lay-filter="qiyeleixing">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in qiyeleixing" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
                        ...
                        <div class="layui-input-block">
                            <select name="yuangongrenshu" id="yuangongrenshu" lay-filter="yuangongrenshu">
                                <option value="">请选择</option>
                                <option v-for="(item,index) in yuangongrenshu" v-bind:key="index" :value="item">{{item}}</option>
                            </select>
                        </div>
                    </div>
                                                                                <div class="layui-form-item" pane>
						...
						<div class="layui-input-block">
							<textarea name="qiyejieshao" id="qiyejieshao">请输入企业介绍</textarea>
						</div>
					</div>
		...
		<script>
			...
			layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate','tinymce'], function() {
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																								...
                																								vue.qiyeleixing = '国有企业,控股企业,外资企业,合资企业,私营企业'.split(',')
																// 上传图片
					...
					error: function() {
						...
						layer.msg("请求接口异常", {
							...
							icon: 5
																...
																vue.yuangongrenshu = '20人以下,20-150人,150-500人,500人以上'.split(',')
				...
				form.on('submit(*)', function(data) {
                    ...
                    // 数据校验
					                    					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					                                                                                                                                                                					var qiyejieshao = tinymce.get('#qiyejieshao').getContent()
					data.qiyejieshao = qiyejieshao;
					...
					// 提交数据
					http.requestJson('qiyexinxi' + '/add', 'post', data, function(res) {
					 	layer.msg('提交成功', {
					 		time: 2000,
					 		icon: 6
					 	}, function() {
