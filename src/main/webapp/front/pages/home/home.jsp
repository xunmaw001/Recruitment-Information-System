...
<body>
    ...
    <div class="plate">
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in zhaopinxinxiRecommend" v-bind:key="index">
                <a target="_self" :href="'../zhaopinxinxi/detail.jsp?id='+item.id">
                  <div class="posi-img">
                    <img :src="item.bangonghuanjing?item.bangonghuanjing.split(',')[0]:''" width="385" height="220" />
                  </div>
                  <div class="remark">
                    <h5>{{item.gangweimingcheng}}</h5>
                  </div>
                </a>
              </li>
            </ul>
      ...
      <div class="plate-pic picture-a after tb80 back-white" style='background:#fff;'>
        <div class="container">
          ...
          <div class="picture-lists">
            <ul class="wul105">
              <li v-for="(item,index) in zhaopinzixunList" v-bind:key="index">
                <a target="_self" :href="'../zhaopinzixun/detail.jsp?id='+item.id">
                  <div class="posi-img">
  ...
  <script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function() {
      ...
      http.request(`zhaopinxinxi/autoSort`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
      ...
      http.request(`zhaopinzixun/list`, 'get', {
        page: 1,
        limit: 6
      }, function(res) {
        vue.zhaopinzixunList = res.data.list;
      });
    });
  </script>
</body>
