				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<input type="hidden" name="id" id="id" />
							...
							<div class="layui-input-block">
								<select name="gangweimingcheng" id="gangweimingcheng">
									<option value="">请选择</option>
									<option v-for="(item,index) in gangweimingcheng" v-bind:key="index" :value="item">{{item}}</option>
								</select>
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="yaoqingshijian" id="yaoqingshijian" placeholder="邀请时间" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							<label class="layui-form-label">邀请内容</label>
							<div class="layui-input-block">
								<input type="text" name="yaoqingneirong" id="yaoqingneirong" placeholder="邀请内容" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                <div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" name="qiyedizhi" id="qiyedizhi" placeholder="企业地址" autocomplete="off" class="layui-input">
							</div>
						</div>
                                                                                                                                                                        <div class="layui-form-item">
					...
					if (res.data.list.length > 0) {
						...
						carousel.render({
							...
							indicator: "none"
                																																...
                																																http.request(`option/zhaopinxinxi/gangweimingcheng`,'get',{},(res)=>{
					vue.gangweimingcheng = res.data
				});
				form.on('select(gangweimingcheng)', (data) => {
					console.log(data.value);
					http.request('follow/zhaopinxinxi/gangweimingcheng', 'get', {
						columnValue: data.value
					}, function(res) {
																																																																		jquery("#gangweizhize").val(res.data.gangweizhize)
