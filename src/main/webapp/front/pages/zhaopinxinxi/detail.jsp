				...
				<div class="layui-row">
					...
					<div class="layui-col-md7" style="padding-left: 20px;">
						...
						<div class="detail-item" style="text-align: right;">
																					...
																					<button v-if="isAuth('zhaopinxinxi','应聘')" @click="onAcrossTap('yingpinxinxi')" type="button" class="layui-btn">
								应聘
							</button>
				...
				<div class="layui-row">
					<div class="layui-tab layui-tab-card">
						...
						<div class="layui-tab-content">
								...
								<div v-html="detail.renzhiyaoqiu"></div>
							</div>
			...
			layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery', 'laypage'], function() {
				...
				http.request(`${vue.detailTable}/detail/` + id, 'get', {}, function(res) {
					...
					vue.detail = res.data
																				...
																				// 轮播图片
					vue.swiperList = vue.detail.bangonghuanjing ? vue.detail.bangonghuanjing.split(",") : [];
																																																																																																																			var swiperItemHtml = '';
