        ...
        <fieldset class="search-container" style="text-align: center;margin: 30px 0;">
          <form class="layui-form">
            ...
            <div class="layui-inline" style="margin-bottom: 10px;">
              ...
              <div class="layui-input-inline">
                <input type="text" name="gangweifenlei" id="gangweifenlei" placeholder="岗位分类" autocomplete="off" class="layui-input">
              </div>
            </div>   
            <div class="layui-inline" style="margin-bottom: 10px;">
              <label class="layui-form-label">行业</label>
              <div class="layui-input-inline">
                <input type="text" name="xingye" id="xingye" placeholder="行业" autocomplete="off" class="layui-input">
              </div>
            </div>   
          ...
          <ul class="after">
            <li v-for="(item,index) in dataList" v-bind:key="index">
              <a target="_self" :href="'../zhaopinxinxi/detail.jsp?id='+item.id">
                <div class="posi-img">
                  <img :src="item.bangonghuanjing?item.bangonghuanjing.split(',')[0]:''" width="385px" height="220px" />
                </div>
                <div class="remark">
  ...
  <script>
    ...
    layui.use(['layer', 'element', 'carousel', 'laypage', 'http', 'jquery'], function() {
      ...
      function pageList() {
        ...
        if (jquery('#xingye').val()) {
          param['xingye'] = jquery('#xingye').val() ? '%' + jquery('#xingye').val() + '%' : '';
        }  
        // 获取列表数据
